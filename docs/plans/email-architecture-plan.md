...
CRITICAL: Every .tsx file in templates/ (including components/) MUST start with /\*_ @jsxImportSource react _/ as the very first line. Without  
...
<Text>{strings.heading}</Text>  
 ...
 {/_ CTA button, fallback URL, expiry note _/}  
 </EmailLayout>  
 );  
 }
...
2. Create templates/<name>.tsx — first line: /\*_ @jsxImportSource react _/
